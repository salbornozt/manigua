    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="crud/update_book.php" method="post" enctype="multipart/form-data">

          <div class="card-header py-3">
              <div class="newspaper">
              <br> 
              <h6 class="m-0 font-weight-bold text-success" align="center">Libros</h6>
            ...
            <div class="card-body">
                    ...
                    <?php
                      $sql = "SELECT b.isbn, b.title, b.publication_date, b.dir, doc.pages, doc.editorial_code, ed.editorial_name
                      from documents doc, book b, editorial ed
                      where 
                      doc.cod_doc = b.cod_doc and
	              ...
	              <div class="form-group"> <!-- Street 1 -->
	              	<label for="street1_id" class="font-weight-bold" >ISBN</label>
          ...
          <div class="modal-body">
            <form action="crud/register_author.php" method="post">
              <table>
                ...
                <tr>
                  <td><label>Número de celular:</label></td>
