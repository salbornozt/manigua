        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="newspaper">
              <br> 
              <h6 class="m-0 font-weight-bold text-success" align="center">Mis libros</h6>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover table-condensed" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody >
                    <?php
                      $sql = "SELECT b.isbn,b.title,b.publication_date,d.cod_doc, e.editorial_name, b.cod_doc, d.status_review
                      FROM book b
                      ...
                      while ($mostrar=pg_fetch_row($result))
                      {
                        ...
                        <a href='eliminar_libro.php?cod_doc=".$mostrar[5]."&src=u' class='btn btn-warning btn-xs' role='button'><span class='fas fa-trash-alt'></span></a>
