...
{
    if($row[0]==$codU){
        $sql = "delete from presentation where cod_doc='".$cod_doc."'";
        ...
        if($src == 'u'){
            echo "<script language='javascript'>alert('Ponencia Eliminada');window.location.href='ponencias_usuario.php'     </script>";

        }else{
            echo "<script language='javascript'>alert('Ponencia Eliminada');window.location.href='ponencias.php'     </script>";

        }
    }
}
if($src == 'u'){
    echo "<script language='javascript'>alert(''Para eliminar un libro debe ser el quien lo creo');window.location.href='ponencias_usuario.php'     </script>";

}else{
    echo "<script language='javascript'>alert(''Para eliminar un libro debe ser el quien lo creo');window.location.href='ponencias.php'     </script>";
