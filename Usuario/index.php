        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success" align="center">Bienvenido a la Libreria Manigua</h6>
            </div>

            <div class="card-body">
              <div id="tabladatatable">

                <br><br><br><br><br><br><br><br><center><h1>Bienvenido, <?php echo $nomUsuario ?>.</h1></center><br><br><br><br><br><br><br><br><br>
