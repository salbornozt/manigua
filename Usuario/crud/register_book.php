...
$i = 1;
$pila = array();
$sql0 = "select * from book where isbn = '".$doc_isbn."'";
    ...
    if(strlen($doc_isbn) <= 13){
        if($auth_num > 0){
            ...
            if(arrayContainsDuplicate($pila)){
                ...
                //insert doc
                $sql1 = "INSERT into documents (cod_doc, status_code, editorial_code, t_doc_code, status_review,pages) VALUES (DEFAULT, 1, ".$editorial_id.", 2, 0, ".$doc_pages.")  RETURNING cod_doc";
                ...
                $destination = '../../Documents/books/book'.$insert_id.'.pdf';
                ...
                if (move_uploaded_file($file, $destination)) {
                    ...
                    $sql2 = "insert into book values ('".$doc_isbn."', '".$doc_title."','{$doc_publication_date}','book".$insert_id."', ".$insert_id.");";
                    pg_query($conexion,$sql2);
    
                } else {
                    $sql2 = "insert into book values ('".$doc_isbn."', '".$doc_title."','{$doc_publication_date}','dir', ".$insert_id.");";
                    pg_query($conexion,$sql2);
