...
if($auth_num > 0){
    ...
    if(arrayContainsDuplicate($pila)){
        ...
        if($_FILES['doc_file']['name'] != null){
            ...
            $sql2 = "UPDATE book SET title = '".$doc_title."', publication_date = '".$doc_publication_date."', dir = 'book".$insert_id."' WHERE cod_doc = ".$cod_doc."";
            pg_query($conexion,$sql2);
        }else{
            $sql2 = "UPDATE book SET title = '".$doc_title."', publication_date = '".$doc_publication_date."' WHERE cod_doc = ".$cod_doc."";
            pg_query($conexion,$sql2);
        }
