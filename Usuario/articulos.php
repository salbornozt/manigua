          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="text-right">
                <a href='registrar_articulo.php' class='btn btn-outline-success' role='button'>Agregar</a>
              </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover table-condensed"  id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody >
                    <?php
                      $sql = "SELECT art.ssn,art.title,art.publication_date,art.cod_doc, e.editorial_name,art.cod_doc FROM article art
                      INNER JOIN DOCUMENTS d on
                      art.cod_doc = d.cod_doc
                      ...
                      while ($mostrar=pg_fetch_row($result))
                      {
                        ...
                        <a href='actualizar_articulo.php?cod_doc=".$mostrar[5]."' class='btn btn-success btn-xs' role='button'><span class='fas fa-edit'></span></a>
                        <a href='eliminar_articulo.php?cod_doc=".$mostrar[5]."&src=n' class='btn btn-warning btn-xs' role='button'><span class='fas fa-trash-alt'></span></a>
                        </td>";
                        echo "</tr>";
                      }
                    ?>                    
