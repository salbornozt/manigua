    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="crud/register_article.php" method="post" enctype="multipart/form-data">
          <div class="card-header py-3">
            ...
            <div class="card-body">
	              ...
	              <div class="form-group"> <!-- Street 1 -->
	              	...
	              	<input type="text" class="form-control" id="doc_isbn" name="doc_isbn" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required> 
	              </div>					
