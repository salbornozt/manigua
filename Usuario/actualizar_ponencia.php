    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form action="crud/update_presentation.php" method="post" enctype="multipart/form-data">
          <div class="card-header py-3">
            ...
            <div class="card-body">
                    <?php
                      $sql = "SELECT p.pres_id, p.title, p.congress_name, p.publication_date, p.dir, doc.pages, doc.editorial_code, ed.editorial_name
                      from documents doc, presentation p, editorial ed
                      where 
                      doc.cod_doc = p.cod_doc and
                      ...
                      while ($mostrar=pg_fetch_row($result))
                      {
                        $doc_isbn = $mostrar[0];
                        $doc_title = $mostrar[1];
                        $doc_congress = $mostrar[2];
                        $doc_date = $mostrar[3];
                        $doc_dir = $mostrar[4];
                        $doc_pages = $mostrar[5];
                        $doc_editorial_code = $mostrar[6];
                        $doc_editorial_name = $mostrar[7];
                ...
                <div class="form-group"> <!-- Street 1 -->
	              	...
	              	<?php echo "<input type='text' class='form-control' id='doc_congress' name='doc_congress' value='".$doc_congress."' required>" ?>
	              </div>					
