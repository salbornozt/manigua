...
$sql="SELECT user_name, user_code, phone, address, email FROM customer WHERE user_code ='".$codU."';";
...
if (isset($_POST['submit'])) 
{
  ...
  {
    $sql3="UPDATE customer SET user_name='$nom', phone='$cel', address='$dir' WHERE user_code='".$codU."';";
