...
{
    if($row[0]==$codU){
        $sql = "delete from book where cod_doc='".$cod_doc."'";
        ...
        if($src == 'u'){
            echo "<script language='javascript'>alert('Libro Eliminado');window.location.href='libros_usuario.php'     </script>";

        }else{
            echo "<script language='javascript'>alert('Libro Eliminado');window.location.href='libros.php'     </script>";

        }
    }
}
if($src == 'u'){
    echo "<script language='javascript'>alert(''Para eliminar un libro debe ser el quien lo creo');window.location.href='libros_usuario.php'     </script>";

}else{
    echo "<script language='javascript'>alert(''Para eliminar un libro debe ser el quien lo creo');window.location.href='libros.php'     </script>";
