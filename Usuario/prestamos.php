...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success" align="center">Tus documentos</h6>
            </div>
            <div class="card-body">
  ...
  <script type="text/javascript">
    function dev_doc(pCodBooking, pCodDocumento){
      alertify.confirm('Devolver Documento', '¿Esta seguro que desea devolver este documento?', 
            function(){ 
              var parametros = {
                  "cod_doc" : pCodDocumento,
                  "cod_booking" : pCodBooking
              };
              $.ajax({
              type:"POST",
              data:parametros,
              url:"Acciones/devolver.php",
              success:function(r){
                console.log(r);
                if(r==1){
                  alertify.success("Se ha devuelto exitosamente");
                  $('#tabladatatable').load('Tablas/tablaPrestamo.php');
                }else{
                  alertify.error("No se pudo devolver");
                } } }); },
            function(){ 
            });}
  </script>
