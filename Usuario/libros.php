          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="text-right">
                <a href='registrar_libro.php' class='btn btn-outline-success' role='button'>Agregar</a>
              </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover table-condensed" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody >
                    <?php
                      $sql = "SELECT b.isbn,b.title,b.publication_date,d.cod_doc, e.editorial_name, b.cod_doc FROM book b
                      ...
                      {
                        $sql2="SELECT status_code from DOCUMENTS where documents.cod_doc = ".$mostrar[5].";";
                        ...
                        echo "<td>";
                        $sql66="SELECT author_name FROM author,document_author WHERE document_author.cod_doc= ".$mostrar[3]." and document_author.author_id = author.author_id;";
...
//                        echo "<td>".$mostrar[3]."</td>";
                        ...
                        if($mostrar2[0]==1){
                          echo '<td>';
                          echo '<center>';
                          echo '<span class="btn btn-success btn-xs" onclick="res_doc('.$mostrar[5].')">';
                        ...
                        <a href='actualizar_libro.php?cod_doc=".$mostrar[5]."' class='btn btn-success btn-xs' role='button'><span class='fas fa-edit'></span></a>
                        <a href='eliminar_libro.php?cod_doc=".$mostrar[5]."&src=n' class='btn btn-warning btn-xs' role='button'><span class='fas fa-trash-alt'></span></a>
                        </td>";
