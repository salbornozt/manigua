        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success" align="center">Reporte libros por mes</h6><br>
              <center>
        ...
        document.cookie = 'cross-site-cookie=bar; SameSite=None; Secure';
            ...
            <div class="card-body">
              <div id="tabladatatable">
                ...
                <br>
                <div align="right">
                <form id="data" name="data" action="A_reportesPDF/A_pdfReporteLibros.php?t=pdf" method="POST">
                  <input type="hidden" id='año' name='año' value='<?php echo $_POST['año']?>' >
                  <input type="hidden" id='mes' name='mes' value='<?php echo $_POST['mes'] ?>' >
                </form>

                <form id="data1" name="data1" action="A_reportesXLS/A_xlsReporteLibros.php?t=xls" method="POST">
                  <input type="hidden" id='año' name='año' value='<?php echo $_POST['año']?>' >
                  <input type="hidden" id='mes' name='mes' value='<?php echo $_POST['mes'] ?>' >
                </form>
