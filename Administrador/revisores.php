...
values ('".$nomA."', 3,'".$maiA."', 'Leer', 'Revisores', '".$fechaF."', '".$ip."');";
...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success" align="center">Revisores</h6>
              <div class="text-right">
                <span class='btn btn-outline-success' data-toggle="modal" data-target="#agregarRevisor"> Agregar <i class="fas fa-user-plus"></i>
              </span>
              </div>
            </div>
            <div class="card-body">
  ...
  <!-- Modal INSERT-->
<div class="modal fade" id="agregarRevisor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar revisor</h5>
      ...
      <div class="modal-body">
        ...
        <table align="center">
          ...
          <tr>
            ...
            <td><input type="number" id="doc" min="1111111" max="9999999999" name="doc" required ></td>
          </tr>

          <tr>
            <td><label>Celular:</label></td>
            <td><input type="number" min="1111111" max="9999999999" id="cel" name="cel" required></td>
          </tr>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnAgregarNuevo" class="btn btn-success">Agregar</button>
      </div>
    </div>
  </div>
</div>
  ...
  $(document).ready(function(){
    ...
    $('#btnAgregarNuevo').click(function(){
      datos=$('#formRevisor').serialize();

    $.ajax({
        type:"POST",
        data:datos,
        url:"Acciones/AgregarRevisor.php",
        success:function(r){
          console.log(r);
          if (r==1)
          {
            ...
            $("#agregarRevisor .close").click();
            $('#tabladatatable').load('A_tablas/A_revisor.php');
          }
          else if(r==3)
          {
          ...
          {
            alertify.error("El documento ingresado ya existe");
          }
          else if(r==5)
          {
            alertify.error("Error al agregar un revisor");
          }
        }
      }); 
  ...
  function deshabilitarRevisor(pCodRevisor){
    ...
    alertify.confirm('Deshabilitar revisor', '¿Seguro desea deshabilitar este revisor?', 
          function(){ 
            var parametros = {
                "cod_revisor" : pCodRevisor
            };
            ...
            type:"POST",
            data:parametros,
            url:"Acciones/DeshabilitarRevisor.php",
            success:function(r){
              if(r==1){
  ...
  alertify.confirm('Habilitar revisor', '¿Seguro desea habilitar este revisor?', 
        function(){ 
          var parametros = {
              "cod_revisor" : pCodRevisor
          };
          ...
          type:"POST",
          data:parametros,
          url:"Acciones/HabilitarRevisor.php",
          success:function(r){
            if(r==1){
