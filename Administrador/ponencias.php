...
values ('".$nomA."', 3,'".$maiA."', 'Leer', 'Ponencias', '".$fechaF."', '".$ip."');";
...
<body id="page-top">
  ...
  function deshabilitarPonencia(pCodPonencia){
    ...
    alertify.confirm('Deshabilitar ponencia', '¿Seguro desea deshabilitar esta ponencia?', 
          function(){ 
            var parametros = {
                "cod_ponencia" : pCodPonencia
            };
            ...
            type:"POST",
            data:parametros,
            url:"Acciones/DeshabilitarPonencia.php",
            success:function(r){
              if(r==1){

                alertify.success("Se deshabilito");
                $('#tabladatatable').load('A_tablas/A_ponencias.php');
  ...
  alertify.confirm('Habilitar ponencia', '¿Seguro desea habilitar esta ponencia?', 
        function(){ 
          var parametros = {
              "cod_ponencia" : pCodPonencia
          };
          ...
          type:"POST",
          data:parametros,
          url:"Acciones/HabilitarPonencia.php",
          success:function(r){
            if(r==1){
