...
values ('".$nomA."', 3,'".$maiA."', 'Leer', 'Articulos', '".$fechaF."', '".$ip."');";
...
<body id="page-top">
  ...
  function deshabilitarArticulo(pCodArticulo){
    ...
    alertify.confirm('Deshabilitar artículo científico', '¿Seguro desea deshabilitar este artículo científico?', 
          function(){ 
            var parametros = {
                "cod_articulo" : pCodArticulo
            };
            ...
            type:"POST",
            data:parametros,
            url:"Acciones/DeshabilitarArticulo.php",
            success:function(r){
              if(r==1){

                alertify.success("Se deshabilito");
                $('#tabladatatable').load('A_tablas/A_articulos.php');
  ...
  alertify.confirm('Habilitar artículo científico', '¿Seguro desea habilitar este artículo científico?', 
        function(){ 
          var parametros = {
              "cod_articulo" : pCodArticulo
          };
          ...
          type:"POST",
          data:parametros,
          url:"Acciones/HabilitarArticulo.php",
          success:function(r){
            if(r==1){
