                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                        $sql = "select count(pres_id) from presentation, documents where presentation.cod_doc = documents.cod_doc and documents.status_code = 1 and documents.status_review = 1;";
                        $result = pg_query($conexion,$sql);
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                        $sql = "select count(ssn) from article, documents where article.cod_doc = documents.cod_doc and documents.status_code = 1 and documents.status_review = 1;";
                        $result = pg_query($conexion,$sql);
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Préstamos</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                        $sql = "select count(booking_code) from booking;";
                        $result = pg_query($conexion,$sql);
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-success" align="center">Préstamos anuales 2020</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
              ...
              $sql1="SELECT count(booking_code) as cantidad
                      ...
                      EXTRACT(YEAR from booking.booking_date)=2020;";
              ...
              {
                  $actual1 = array("label"=> 'Artículos', "y"=> $mostrar1[0]);
                  array_push($datosMes, $actual1);
              }

              while($mostrar2=pg_fetch_row($result2))
              {
                  $actual2 = array("label"=> 'Libros', "y"=> $mostrar2[0]);
                  array_push($datosMes, $actual2);
              }

              while($mostrar3=pg_fetch_row($result3))
              {
                  $actual3 = array("label"=> 'Ponencias', "y"=> $mostrar3[0]);
                  array_push($datosMes, $actual3);
              }
