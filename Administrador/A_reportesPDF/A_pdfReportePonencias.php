...
<h3 align="left">ASUNTO: Reporte ponencias por mes</h3>
...
<hr>
<h4 style="text-align: justify;">Cordial saludo señor administrador, por medio de la presente se hace entrega del informe detallado sobre el prestamo de ponencias en el mes <?php echo $mes ?> del año <?php echo $_POST['año']; ?>.</h4>
<br>
<h2>Reporte ponencias por mes <?php echo '('.$mes.'/'.$_POST['año'].')'; ?></h2>
<br>
...
$dompdf->render();
$dompdf->stream("ReportePonencias(".$mes."_".$_POST['año'].").pdf");
?>