...
values ('".$nomA."', 3,'".$maiA."', 'Leer', 'Libros', '".$fechaF."', '".$ip."');";
...
<body id="page-top">
  ...
  function deshabilitarLibro(pCodLibro){
    ...
    alertify.confirm('Deshabilitar libro', '¿Seguro desea deshabilitar este libro?', 
          function(){ 
            var parametros = {
                "cod_libro" : pCodLibro
            };
            ...
            type:"POST",
            data:parametros,
            url:"Acciones/DeshabilitarLibro.php",
            success:function(r){
              if(r==1){

                alertify.success("Se deshabilito");
                $('#tabladatatable').load('A_tablas/A_libros.php');
  ...
  alertify.confirm('Habilitar libro', '¿Seguro desea habilitar este libro?', 
        function(){ 
          var parametros = {
              "cod_libro" : pCodLibro
          };
          ...
          type:"POST",
          data:parametros,
          url:"Acciones/HabilitarLibro.php",
          success:function(r){
            if(r==1){
