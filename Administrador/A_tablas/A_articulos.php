...
$sql1="SELECT * FROM article, documents where article.cod_doc = documents.cod_doc and documents.status_review = 1;";
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <?php if( $mostrar[6] == 1){ ?>
                          <center><span class="btn btn-warning btn-xs" onclick="deshabilitarArticulo(<?php echo $mostrar[5] ?> )">
                            <span class="fas fa-user-alt-slash"></span>
                          </span></center>
                        <?php  } else if ($mostrar[6] == 3) { ?>
                          <center><span class="btn btn-success btn-xs" onclick="habilitarArticulo(<?php echo $mostrar[5] ?> )">
