...
values ('".$nomA."', 3,'".$maiA."', 'Leer', 'Usuarios', '".$fechaF."', '".$ip."');";
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success" align="center">Usuarios</h6>
            </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#tabladatatable').load('A_tablas/A_usuarios.php');
  });
</script>