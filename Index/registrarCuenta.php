                        ...
                        <div class="d-flex justify-content-center"><br>
                            <div class="bg-green">
                                <br><br><br>
                                    ...
                                    <span class="underline center"></span>
                                <br><br>
                                <center><h2>Registrarte</h2></center><br><br>
                                <form action="registrarCuentaExitoso.php#section-4" method="post" class="contact-form">
                                    <div class="row form-group" style="margin-left: 105px; margin-right: 105px;">
                                        <div class="col-md-6"><input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombres y apellidos" required/></div>

                                        <div class="col-md-6"><input type="number" min="1111111" max="9999999999" id="cedula" name="cedula" class="form-control" placeholder="Documento" required/></div>
                                    </div>

                                    <div class="row form-group" style="margin-left: 105px; margin-right: 105px;">
                                        <div class="col-md-6"><input type="text" id="correo" name="correo" class="form-control" placeholder="Correo electrónico" required/></div>

                                        <div class="col-md-6"><input type="password" minlength="6" maxlength="12" id="pass" name="pass" class="form-control" placeholder="Contraseña" required/></div>
                                    </div>

                                    <div class="row form-group" style="margin-left: 105px; margin-right: 105px;">
                                        <div class="col-md-6"><input type="number" min="1111111" max="9999999999" id="tel" name="tel" class="form-control" placeholder="Número de contacto" required/></div>

                                        <div class="col-md-6"><input type="text" id="residencia" name="residencia" class="form-control" placeholder="Dirección de residencia" required/></div>
                                    </div>
                                    <br>
                                    <button type="submit" class="btn btn-primary tm-btn-primary">REGISTRARTE</button><br><br>
                                    <center><strong><a href="index.php#section-4"  id="show">Iniciar sesión</a></strong></center><br><br>
                                </form>
                            </div>
                            <br><br>    
                        </div>
