                        ...
                        <div class="d-flex justify-content-center"><br>
                            <div class="bg-green">
                                <br><br><br>
                                    ...
                                    <span class="underline center"></span>
                                <br><br>
                                <center><h2>Recupera tu contraseña</h2></center><br><br>
                                <form action="recuperarCuentaExitoso.php#section-4" method="post" class="contact-form">
                                    <div class="form-group" style="margin-left: 120px; margin-right: 120px;">
                                        <input type="number" min="1111111" max="9999999999" id="cedula" name="cedula" class="form-control" placeholder="Documento" required/>
                                    </div>
                                    <div class="form-group" style="margin-left: 120px; margin-right: 120px;">
                                        <input type="text" id="correo" name="correo" class="form-control pl-3" placeholder="Correo electrónico" required/>
                                    </div>
                                    <br>
                                    <button type="submit" class="btn btn-primary tm-btn-primary">RECUPERAR</button><br><br>
                                    <center><strong><a href="index.php#section-4" id="hide">Iniciar sesión</a></strong></center><br><br>
                                </form>
                            </div>
                            <br><br>    
                        </div>
