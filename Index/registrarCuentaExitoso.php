                        ...
                        <div class="d-flex justify-content-center"><br>
                            <div class="bg-green">
                                ...
                                <?php
                                    ...
                                    $cont = $_POST['pass'];
                                    $cel = $_POST['tel'];
                                    $dir = $_POST['residencia'];
                                    $clave = md5($cont);

                                    echo '<center><h1 style="color: white;">Registro exitoso '.$name.'!</h1></center><br><br>';
                                    echo '<h4 style="color: white;">Pronto te contactaremos por medio del correo:<br> '.$email.'<br><br>';
                                    ...
                                    if (preg_match($patron, $email)) 
                                    {
                                        ...
                                        $sql2 ="SELECT * FROM customer WHERE user_code = '$doc'";
                                        $result2 = pg_query($conexion,$sql2);

                                        if(pg_num_rows($result)!=0)
                                        {
                                          echo '<script language="javascript">alert("El correo ya se encuentra registrado");window.location.href="registrarCuenta.php#section-4"</script>';
                                        }
                                        elseif (pg_num_rows($result2)!=0) 
                                        {
                                          echo '<script language="javascript">alert("El número de identificación ya se encuentra registrado");window.location.href="registrarCuenta.php#section-4"</script>';
                                        }
                                        else
                                        {
                                            $imp = "
                                            ...
                                            <div style='background-color: #7bc142;'>
                                                <center><br><h1 style='color: #ffffff'>Librer&iacute;va Manigua</h1><br></center>
                                            </div>

                                            <div style='text-align: center;'>
                                            <h2><br>Hola ".$name.", te has registado en la librer&iacute;a Manigua
                                            ...
                                            try 
                                            {
                                                ...
                                                if($mail->send())
                                                {
                                                    $sql ="INSERT INTO customer VALUES ('$doc', '$name', '$dir', '$cel', '$email', '$clave', 1, 'A')";             
                                    ...
                                    {
                                          echo '<script language="javascript">alert("Correo invalido - Usuario");window.location.href="registrarCuenta.php#section-4"</script>';
                                    }
                                ?>
                            </div>
                            <br><br>    
