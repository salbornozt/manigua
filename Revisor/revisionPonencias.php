...
values ('".$name."', 2,'".$mail."', 'Leer', 'Ponencias', '".$fechaF."', '".$ip."');";
              ...
              <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                <form class="form-inline mr-auto w-100 navbar-search">
                  <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="Bucar por..." aria-label="Busqueda" aria-describedby="basic-addon2">
...
<script type="text/javascript">
  function habi_doc(pCod){
    alertify.confirm('Habilitar ponencia', '¿Seguro desea habilitar este ponencia?', 
          function(){ 
            var parametros = {
                "cod" : pCod
            };
            ...
            success:function(r){
              if(r==1){
                ...
                $('#tabladatatable').load('Tablas/tabla_ponencia.php');
              }else{
...
<script type="text/javascript">
  function desa_doc(pCod){
    alertify.confirm('Deshabilitar ponencia', '¿Seguro desea deshabilitar este ponencia?', 
          function(){ 
            var parametros = {
                "cod" : pCod
            };
