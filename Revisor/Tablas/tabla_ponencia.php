                  ...
                  ?>
                    <tr>
                      ...
                      <td><center><?php echo $mostrar[3] ?></center></td>
                       <!--MODAL-->
                      <td>
                        <div class="modal fade" id="info<?php echo $mostrar[5]; ?>">
                        ...
                        <center><table>
                                  ...
                                  <?php
                                  $sql0="SELECT * FROM presentation WHERE cod_doc='".$mostrar[5]."'";
                                  $result00=pg_query($conexion,$sql0); 
                                  while ($mostrar00=pg_fetch_row($result00))
                                  {  ?>
                                    <tr><td>Código: <?php echo $mostrar[5] ?></td></tr>
                                    <tr><td>Id : <?php echo $mostrar00[0] ?></td></tr>
                                    <tr><td>Título : <?php echo $mostrar00[1] ?></td></tr>
                                    <tr><td>Congreso : <?php echo $mostrar00[2] ?></td></tr>
                                    <tr><td>Fecha : <?php echo $mostrar00[3] ?></td></tr>
                                    <tr><td>Directorio : <?php echo $mostrar00[4] ?></td></tr>
                                    
                                  <?php
                                  $sql01=" SELECT author_name FROM presentation,documents,document_author,author
                                  WHERE presentation.cod_doc='".$mostrar[5]."' AND
                                  presentation.cod_doc=documents.cod_doc AND 
                                  ...
                                  <?php  } ?>
                                  <?php
                                  $sql02=" SELECT editorial_name FROM presentation,documents,editorial
                                  WHERE presentation.cod_doc='".$mostrar[5]."' AND
                                  presentation.cod_doc=documents.cod_doc AND 
                                  ...
                                  <?php  } ?>
                                  <?php
                                  $sql03=" SELECT pages FROM presentation,documents
                                  WHERE presentation.cod_doc='".$mostrar[5]."' AND
                                  presentation.cod_doc=documents.cod_doc ";
                      ...
                      <center>
                      <span class="btn btn-info" data-toggle="modal" data-target="#info<?php echo $mostrar[5];?>"><i class="fas fa-eye"></i></span>
                      </center>
                      </td>
                      <!--fin MODAL-->
                      <td><center>
                        <?php 
                        $sql11="SELECT status_review FROM presentation,documents WHERE '".$mostrar[5]."'= presentation.cod_doc  AND presentation.cod_doc = documents.cod_doc";
                      ...
                      <td>
                        <?php 
                        $sql12="SELECT status_review FROM presentation,documents WHERE '".$mostrar[5]."'= presentation.cod_doc  AND presentation.cod_doc = documents.cod_doc";
                        $result12=pg_query($conexion, $sql12);
                        while ($fila12= pg_fetch_array($result12)) 
                          {
                        if( $fila12[0] == 0){ ?>  
                          <center>
                          <span class="btn btn-success btn-xs" onclick="habi_doc(<?php echo $mostrar[5]?>)">
                          <span class="fas fa-check-square"></span></span>
                          <span class="btn btn-warning btn-xs" onclick="desa_doc(<?php echo $mostrar[5]?>)">
