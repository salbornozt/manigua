                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <center><table>
                                  <?php
                                  $sql0="SELECT * FROM book WHERE cod_doc='".$mostrar[4]."'";
                                  $sql1=" SELECT author_name FROM book,documents,document_author,author
                                  WHERE book.cod_doc=2 AND
                                  book.cod_doc=documents.cod_doc AND 
                                  ...
                                  <?php
                                  $sql01=" SELECT author_name FROM book,documents,document_author,author
                                  WHERE book.cod_doc='".$mostrar[4]."' AND
                                  book.cod_doc=documents.cod_doc AND 
                                  documents.cod_doc=document_author.cod_doc AND
                                  document_author.author_id=author.author_id;";
                                  ...
                                  <?php  } ?>
                                  <?php
                                  $sql02=" SELECT editorial_name FROM book,documents,editorial
                                  WHERE book.cod_doc='".$mostrar[4]."' AND
                                  book.cod_doc=documents.cod_doc AND 
                                  ...
                                  <?php  } ?>
                                  <?php
                                  $sql03=" SELECT pages FROM book,documents
                                  WHERE book.cod_doc='".$mostrar[4]."' AND
                                  book.cod_doc=documents.cod_doc ";
                      ...
                      <td><center>
                        <?php 
                        $sql11="SELECT status_review FROM book,documents WHERE '".$mostrar[4]."'= book.cod_doc  AND book.cod_doc = documents.cod_doc";
                      ...
                      <td>
                        <?php 
                        $sql12="SELECT status_review FROM book,documents WHERE '".$mostrar[4]."'= book.cod_doc  AND book.cod_doc = documents.cod_doc";
